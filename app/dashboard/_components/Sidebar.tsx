...
const Sidebar = () => {
  ...
  return (
    <div className="w-full pt-6 px-4 pb-8 border-e-[1px] border-[#DEDEDE] h-screen flex flex-col justify-between">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex gap-2 items-center">
            <img
              ...
              alt="User"
            />
            <div className="text-xl font-medium">Keshav Malik</div>
          </div>
          <div className="flex justify-between items-center">
            ...
            <button className="p-2 bg-[#F4F4F4] rounded-[4px] text-[#797979]">
              Logout
            </button>
          </div>
        </div>
